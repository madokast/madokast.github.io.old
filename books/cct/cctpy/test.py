...
class P2Case(unittest.TestCase):
    ...
    def test_p2_norm(self):
        p = P2(1, 1)
        self.assertTrue(BaseUtils.equal(p.normalize(), P2(
    ...
    def test_p2_copy(self):
        for i in range(100):
            ...
            self.assertTrue(BaseUtils.equal(
                p, p.copy()
            ))
...
class P3Case(unittest.TestCase):
    ...
    def test_change_length(self):
        for i in range(100):
            ...
            d = random.random() + i
            self.assertTrue(BaseUtils.equal(
                P3(a, b, c).change_length(d).length(),
                d
            ))
...
class TrajectoryTestCase(unittest.TestCase):
    ...
    def test_tr_01(self):
        t = Trajectory(StraightLine2(2.0, P2(1, 0), P2(0, 0))) \
    ...
    def test_tr_02(self):
        ...
        """
        c1 = Trajectory(
            StraightLine2(0.01, P2(0, 1), P2(0, 0))
        ).add_arc_line(
            1, True, 135
        ).add_arc_line(
            0.01, True, 90
